...
これらのスクリプトは、一般公開されている[AWS IoT Core 基礎ワークショップ](https://catalog.workshops.aws/workshops/a007780e-1086-421b-a7e3-b7ac63e37089)のベースとしても使われています。ツールキット自体に加えて、このワークショップはガイド付きの実践的な体験を通じて、AWS IoT Coreのさまざまなユースケースをより深く理解するのに最適です。
